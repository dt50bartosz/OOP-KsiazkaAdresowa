...
int PlikZAdresatami::wczytajAdresatowZalogowanegoUzytkownikaZPliku(vector <Adresat>& adresaci, int idZalogowanegoUzytkownika)
{
    ...
    {
        idOstatniegoAdresata = pobierzIdOstaniegoAdresata(daneOstaniegoAdresataWPliku);
...
int PlikZAdresatami::pobierzIdOstaniegoAdresata(string tekst) {
    
    int pozycjaRozpoczeciaIdAdresata = 0;
    int idAdresata = MetodyPomocnicze::konwersjaStringNaInt(pobierzLiczbe(tekst, pozycjaRozpoczeciaIdAdresata));
    return idAdresata;
}
    ...
    for (int pozycjaZnaku = 0; pozycjaZnaku < daneAdresataOddzielonePionowymiKreskami.length(); pozycjaZnaku++)
    {
        ...
        else
        {
            ...
            case 6:
                ...
                break;
            case 7:
                adresat.ustawAdras(pojedynczaDanaAdresata);
                break;
            }
